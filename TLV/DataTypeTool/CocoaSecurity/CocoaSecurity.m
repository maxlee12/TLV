...
+ (NSData *)encryptAes128Data:(NSData *)data andkey:(NSString *)key
{
    ...
    if (cryptStatus == kCCSuccess) {
        ...
        NSData * enData = [NSData dataWithBytes:buffer length:encryptedSize];
...
+ (NSData *)decryptAes128Data:(NSData *)data andkey:(NSString *)key{
